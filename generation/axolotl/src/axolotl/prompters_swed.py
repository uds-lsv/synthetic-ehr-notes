...
class AlpacaPrompter(Prompter):
    ...
    system_prompt = "Nedan är en instruktion som beskriver en uppgift, parad med en ingång som ger ytterligare sammanhang. Skriv ett svar som på lämpligt sätt kompletterar begäran."
