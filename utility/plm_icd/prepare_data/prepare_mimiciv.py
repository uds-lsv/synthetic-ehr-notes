...
sys.path.insert(0, 'utility/medical_coding/plm_icd')
...
preprocessor = TextPreprocessor(
    lower=False,#True,
    remove_special_characters_mullenbach=False,#True,
    remove_special_characters=False,
    remove_digits=False, #True,
    remove_accents=False, #False,
    remove_brackets=False,
    convert_danish_characters=True,#False,
    remove_adapted=True #new preprocessing method
)
